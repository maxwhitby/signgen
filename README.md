...
**Latest Updates (v1.0.3)**: Fixed GUI preview panel layout, improved control responsiveness, refined text weight rendering. See [CHANGELOG](CHANGELOG.md) for details.
